...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <h2>Registrar Nuevo Documento <span class="badge-revisar">ESTADO: EN REVISIÓN</span></h2>
            ...
            <div class="section-card">
                <h3>&#128203; 2. Clasificación del Documento</h3>
                <div class="row">
                    <div class="col-md-6">
                        <label>Área de Origen (Parte el documento):</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <asp:TextBox ID="TxtAsunto" runat="server" MaxLength="300" placeholder="Ej. Aprobación de Plan de Contingencia..."></asp:TextBox>
            ...
            <div class="section-card">
                ...
                <asp:Button ID="BtnAgregarFirmante" runat="server" Text="+ Añadir" OnClick="BtnAgregarFirmante_Click" CssClass="btn btn-secondary" CausesValidation="false" />
            </div>
            
            <div style="text-align: right; margin-top: 1rem; border-top: 1px solid var(--surface-border); padding-top: 1.5rem;">
                <asp:Button ID="BtnRegistrar" runat="server" Text="Registrar Trámite" OnClick="BtnRegistrar_Click" CssClass="btn" style="font-size: 1.1rem; padding: 0.8rem 2rem;" />
            </div>
        </div>
    </form>
